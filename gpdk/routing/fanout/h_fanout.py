...
class HFanout(fp.PCell):
    ...
    device_left_ports: Optional[Sequence[str]] = fp.NameListParam(required=False, doc="device left ports from top to bottom")
    device_right_ports: Optional[Sequence[str]] = fp.NameListParam(required=False, doc="device right ports from bottom to top")
