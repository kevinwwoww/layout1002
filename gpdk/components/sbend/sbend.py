...
class SBend(fp.PCell):
    ...
    max_distance: Optional[float] = fp.PositiveFloatParam(required=False)
...
if __name__ == "__main__":
    ...
    def mwg_bend_factory(central_angle: float):
        bend = pdk.BendCircular(degrees=math.degrees(central_angle), radius=15, waveguide_type=TECH.WG.MWG.C.WIRE)
        return bend, bend.radius, ("op_0","op_1")
