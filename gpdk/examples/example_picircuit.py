...
from gpdk.components.ring_modulator.ring_modulator import RingModulator
from gpdk.routing.fanout.h_fanout import HFanout
...
def bend_factories(waveguide_type: fp.IWaveguideType):
    if waveguide_type == TECH.WG.FWG.C.WIRE:
        return EulerBendFactory(radius_min=5, l_max=8, waveguide_type=waveguide_type)
