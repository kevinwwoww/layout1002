...
@dataclass(eq=False)
class Circuit03_passive_demux(fp.PCell):
    def build(self):
        ...
        gc_1 = gc.translated(1200, 100)
        gc_2 = gc.translated(1200, -100)
        dc_0 = fp.place(dc, "op_0", at=(0, 0))
        dc_1 = fp.place(dc, "op_0", at=(1000, 0))
        t_0 = t.rotated(degrees=270).translated(-100, -100)
        rs_t_0 = rs.translated(dc_y + 200 - rs_y / 2, 200)
        rs_t_1 = rs.translated(dc_y + 400 - rs_y / 2, 200)
        rs_t_2 = rs.translated(dc_y + 600 - rs_y / 2, 200)
        rs_t_3 = rs.translated(dc_y + 800 - rs_y / 2, 200)
        rs_b_0 = rs.translated(dc_y + 200 - rs_y / 2, -200)
        rs_b_1 = rs.translated(dc_y + 400 - rs_y / 2, -200)
        rs_b_2 = rs.translated(dc_y + 600 - rs_y / 2, -200)
        rs_b_3 = rs.translated(dc_y + 800 - rs_y / 2, -200)
        ...
        device = fp.Linked(
            ...
            links=[
                gc_0["op_0"] >> dc_0["op_0"],
                t_0["op_0"] >> dc_0["op_1"],
                rs_t_0["op_0"] >> dc_0["op_3"],
                rs_b_0["op_0"] >> dc_0["op_2"],
                rs_t_0["op_1"] >> rs_t_1["op_0"],
                rs_t_1["op_1"] >> rs_t_2["op_0"],
                rs_t_2["op_1"] >> rs_t_3["op_0"],
                rs_t_3["op_1"] >> dc_1["op_0"],
                rs_b_0["op_1"] >> rs_b_1["op_0"],
                rs_b_1["op_1"] >> rs_b_2["op_0"],
                rs_b_2["op_1"] >> rs_b_3["op_0"],
                rs_b_3["op_1"] >> dc_1["op_1"],
                gc_1["op_0"] >> dc_1["op_3"],
                gc_2["op_0"] >> dc_1["op_2"],
            ],
            ports=[
