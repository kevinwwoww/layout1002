...
class heater(fp.PCell):
    def build(self):
        ...
        TECH = get_technology()
        box = fp.el.Line(length=20, stroke_width=10, layer=TECH.LAYER.TIN_DRW, anchor=fp.Anchor.CENTER)
        elems += box
        ports += fp.Pin(name="ep_0", position=(0, 0), orientation=90, shape=box.shape, metal_line_type=TECH.METAL.M1.W10)
