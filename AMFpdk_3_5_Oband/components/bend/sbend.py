...
from AMFpdk_3_5_Oband.components.bend.bend_circular import Bend, Bend90
from AMFpdk_3_5_Oband.components.straight.straight import Straight, StraightBetween


@dataclass(eq=False)
class Sbend(fp.IWaveguideLike, fp.PCell):
    Width: float = fp.PositiveFloatParam(default=0.41)
