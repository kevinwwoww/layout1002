...
from AMFpdk_3_5_Oband.technology.interfaces import CoreWaveguideType, SlabWaveguideType
from AMFpdk_3_5_Oband.technology.waveguide_factory import StraightFactory, CircularBendFactory
