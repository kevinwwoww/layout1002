...
from AMFpdk_3_5_Oband.technology.metal import METAL
...
class _Vias(fpt.IViasFactory):
    ...
    def __call__(self, curve: fpt.ICurve, length: float) -> Tuple[fpt.IElement, Tuple[float,float]]:
        from AMFpdk_3_5_Oband.components.via.via import Via
        from AMFpdk_3_5_Oband.components.via.vias import Vias
