# Generated from C:\photoCAD\layout1002\AMFpdk_3_5_Oband\technology\layers.csv
...
class LAYER(LayerEnum):
    ...
    LABEL = Layer(PROCESS.LABEL, PURPOSE.DRW, '(non-tapeout) Label')
