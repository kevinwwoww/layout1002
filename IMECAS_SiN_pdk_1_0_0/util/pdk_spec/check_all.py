...
if __name__ == "__main__":
    # from IMECAS_SiN_pdk_1_0_0.util.standard_check_util.technology.bands import BandsCheckRule
    # extend_rules = (BandsCheckRule(),)
    # import IMECAS_SiN_pdk_1_0_0
    # check_pdk(pdk=IMECAS_SiN_pdk_1_0_0, extend_rules=extend_rules)

    # import IMECAS_SiN_pdk_1_0_0
    # check_pdk(pdk=IMECAS_SiN_pdk_1_0_0)
    # check_pdk(pdk=IMECAS_SiN_pdk_1_0_0, mode="extend")
