...
def _c_channel2slab(end_types: Tuple[fpt.IWaveguideType, fpt.IWaveguideType]):
    from AMFpdk_3_5_Cband.components.transition.channel2slab_transition import CHANNEL2SLABTransition
...
class _Taper:
    ...
    def __call__(self, end_types: Tuple[fpt.IWaveguideType, fpt.IWaveguideType]):
        from AMFpdk_3_5_Cband.components.taper.taperH import taperH
