...
from AMFpdk_3_5_Cband_0420.technology.interfaces import CrackedMetalLineType
from AMFpdk_3_5_Cband_0420.technology.metal import METAL
...
class _Vias(fpt.IViasFactory):
    ...
    def __call__(self, curve: fpt.ICurve, length: float) -> Tuple[fpt.IElement, Tuple[float,float]]:
        from AMFpdk_3_5_Cband_0420.components.via.via import Via
        from AMFpdk_3_5_Cband_0420.components.via.vias import Vias
