...
if __name__ == "__main__":
    # from CT_Cu_pdk.util.standard_check_util.technology.bands import BandsCheckRule
    # extend_rules = (BandsCheckRule(),)
    # import CT_Cu_pdk
    # check_pdk(pdk=CT_Cu_pdk, extend_rules=extend_rules)

    # import CT_Cu_pdk
    # check_pdk(pdk=CT_Cu_pdk)
    # check_pdk(pdk=CT_Cu_pdk, mode="extend")
