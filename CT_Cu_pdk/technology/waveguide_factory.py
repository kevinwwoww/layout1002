...
class CircularBendFactory(fpt.IBendWaveguideFactory):
    ...
    def __call__(self, central_angle: float):
        from CT_Cu_pdk.components.bend.bend_circular import BendCircular, BendCircular90, BendCircular90_Strip_WG_C_WIRE
...
class EulerBendFactory(fpt.IBendWaveguideFactory):
    ...
    def __call__(self, central_angle: float):
        from CT_Cu_pdk.components.bend.bend_euler import BendEuler, BendEuler90, BendEuler90_Strip_WG_C_WIRE
