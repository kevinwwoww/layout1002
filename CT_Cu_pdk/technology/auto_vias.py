...
from CT_Cu_pdk.technology.interfaces import CrackedMetalLineType
from CT_Cu_pdk.technology.metal import METAL
...
class _Vias(fpt.IViasFactory):
    ...
    def __call__(self, curve: fpt.ICurve, length: float) -> Tuple[fpt.IElement, Tuple[float, float]]:
        ...
        from CT_Cu_pdk.components.via.vias import Vias
