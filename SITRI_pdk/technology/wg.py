...
from SITRI_pdk.technology.interfaces import CoreWaveguideType, SlabWaveguideType
from SITRI_pdk.technology.waveguide_factory import StraightFactory, CircularBendFactory
