...
from AMFpdk.components.bend.bend_euler import BendEuler
...
class YSplitter(fp.PCell):
    ...
    def build(self) -> Tuple[fp.InstanceSet, fp.ElementSet, fp.PortSet]:
        ...
        bend_top = BendEuler(radius_eff=bend_radius, degrees=out_degrees, waveguide_type=waveguide_type).translated(0, wg_width / 2)
...
if __name__ == "__main__":
    ...
    library += YSplitter(out_degrees=60)
