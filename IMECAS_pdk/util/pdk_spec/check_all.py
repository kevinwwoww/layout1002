...
if __name__ == "__main__":
    # from IMECAS_pdk.util.standard_check_util.technology.bands import BandsCheckRule
    # extend_rules = (BandsCheckRule(),)
    # import IMECAS_pdk
    # check_pdk(pdk=IMECAS_pdk, extend_rules=extend_rules)

    # import IMECAS_pdk
    # check_pdk(pdk=IMECAS_pdk)
    # check_pdk(pdk=IMECAS_pdk, mode="extend")
