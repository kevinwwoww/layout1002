...
from AMFpdk.components.transition._channel_transition import CHANNELtransition
from AMFpdk.technology import get_technology, WG

@dataclass(eq=False)
class CHANNEL2RIBTransition(fp.ICurvedCellRef, fp.PCell):
