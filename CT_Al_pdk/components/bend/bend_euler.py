...
from CT_Al_pdk.technology.interfaces import CoreWaveguideType, SlabWaveguideType
...
class BendEuler90_Strip_WG_C_WIRE(BendEuler90, locked=True):
    ...
    radius_min: float = fp.PositiveFloatParam(default=5, doc="Bend radius_min")
    waveguide_type: CoreWaveguideType = fp.WaveguideTypeParam(type=CoreWaveguideType, doc="Waveguide parameters")
    slab_square: bool = fp.BooleanParam(required=False, default=False, doc="whether draw a square clad")
...
@dataclass(eq=False)
class BendEuler90_Rib_WG_C_WIRE(BendEuler):
    l_max: Optional[float] = fp.PositiveFloatParam(required=False, doc="Bend Lmax")
    radius_min: float = fp.PositiveFloatParam(default=10, doc="Bend radius_min")
    waveguide_type: SlabWaveguideType = fp.WaveguideTypeParam(type=SlabWaveguideType, doc="Waveguide parameters")
    slab_square: bool = fp.BooleanParam(required=False, default=False, doc="whether draw a square clad")
...
if __name__ == "__main__":
    ...
    library += BendEuler()
    library += BendEuler90_Rib_WG_C_WIRE(radius_eff=10)
