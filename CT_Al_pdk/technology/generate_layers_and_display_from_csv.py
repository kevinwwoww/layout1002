...
#   Same DATATYPE name have to be same PURPOSE
#   PURPOSE can be blank
...
# 1,1,Hard_Mask_WG_COR,"Full Etch waveguide core","Hard_Mask_WG", "Full etch","COR","Waveguide core",BLUE,DIAGONAL,BLUE
#
