...
if __name__ == "__main__":
    # from CT_Al_pdk.util.standard_check_util.technology.bands import BandsCheckRule
    # extend_rules = (BandsCheckRule(),)
    # import CT_Al_pdk
    # check_pdk(pdk=CT_Al_pdk, extend_rules=extend_rules)

    # import CT_Al_pdk
    # check_pdk(pdk=CT_Al_pdk)
    # check_pdk(pdk=CT_Al_pdk, mode="extend")
