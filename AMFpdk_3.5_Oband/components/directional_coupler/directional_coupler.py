...
class DirectionalCoupler(fp.PCell):
    coupler_spacing: float = fp.PositiveFloatParam(default=0.2, doc="Coupler spacing, set by AMF device manual")
    ...
    def build(self) -> Tuple[fp.InstanceSet, fp.ElementSet, fp.PortSet]:
        ...
        straight_coupler = Straight(name="coupler", length=coupler_length, anchor=fp.Anchor.CENTER, waveguide_type=waveguide_type, transform=fp.translate(0, -dy - 0.25))
