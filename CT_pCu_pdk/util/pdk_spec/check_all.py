...
if __name__ == "__main__":
    # from CT_pCu_pdk.util.standard_check_util.technology.bands import BandsCheckRule
    # extend_rules = (BandsCheckRule(),)
    # import CT_pCu_pdk
    # check_pdk(pdk=CT_pCu_pdk, extend_rules=extend_rules)

    # import CT_pCu_pdk
    # check_pdk(pdk=CT_pCu_pdk)
    # check_pdk(pdk=CT_pCu_pdk, mode="extend")
